...
const FAQS = [
  {
    title: "🤔 What is Th3-Flix?",
    description:
      "Just like every other website, Th3-Flix is also a streaming site that helps to easily access all the TV shows and movies we wanted, without spending hours searching for them.",
  },
  {
